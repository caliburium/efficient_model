...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-root', default='/data/unagi0/matsuura/PACS/raw_images/kfold/')
    parser.add_argument('--save-root', default='/data/unagi0/matsuura/result/dg_mmld/')
    parser.add_argument('--result-dir', default='$dir_name')
    ...
    parser.add_argument('--exp-num', type=int, default='$j')
