...
import wandb
# from dataloader.data_loader import data_loader # 기존 data_loader 대신
from dataloader.DomainNetLoader import dn_loader  # DomainNetLoader 사용 (가정)
...
def main():
    ...
    parser.add_argument('--data', type=str, default='Furniture')
    args = parser.parse_args()

    num_epochs = args.epoch

    DOMAIN_CLASSES = {
        'Furniture': [246, 110, 15, 213, 139, 299, 58, 102, 47, 48],
        'Mammal': [61, 292, 81, 148, 319, 157, 83, 188, 312, 89],
        'Tool': [314, 131, 227, 12, 40, 249, 10, 237, 207, 276],
    }
    if args.data in DOMAIN_CLASSES:
        class_indices = DOMAIN_CLASSES[args.data]
        loader, test_loader = dn_loader('real', class_indices, args.batch_size)
    else:
        print(f'[Error] Wrong data type: {args.data}. Must be one of Furniture, Mammal, or Tool.')
    ...
    wandb.init(entity="hails",
               ...
               name="[CNN]DomainNet_" + str(args.data)
